    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
                ...
                {successMsg && (
                    <div
                        className="mb-6 p-4 bg-emerald-50 border border-emerald-100 text-emerald-600 rounded-2xl text-sm font-medium flex items-center gap-2 animate-in fade-in duration-300">
                ...
                {errorMsg && (
                    <div
                        className="mb-6 p-4 bg-red-50 border border-red-100 text-red-500 rounded-2xl text-sm font-medium animate-in fade-in duration-300">
                        {errorMsg}
                    </div>
                )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
                    ...
                    <div
                        className="md:col-span-4 bg-white rounded-[2rem] border border-gray-100 shadow-[0_15px_30px_rgba(0,0,0,0.02)] p-8 flex flex-col items-center">

                        {/* Avatar container */}
                        <div className="relative w-28 h-28 mb-6 group cursor-pointer" onClick={handleAvatarClick}>
                            <div
                                className="w-full h-full rounded-full border-4 border-purple-50 overflow-hidden bg-slate-100 flex items-center justify-center shadow-md">
                                {uploading ? (
                                    <Loader2 className="w-8 h-8 text-[#6b5b95] animate-spin"/>
                                ) : avatarUrl ? (
                                    <img src={avatarUrl} alt={user.fullName || "User Avatar"}
                    ...
                    <div
                        className="md:col-span-8 bg-white rounded-[2rem] border border-gray-100 shadow-[0_15px_30px_rgba(0,0,0,0.02)] p-8 md:p-10">
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <label
                                                className="text-[10px] uppercase tracking-[0.1em] font-bold text-[#9ca3af] ml-1">
                                                Họ
                                            </label>
                                            <input
                                                type="text"
                                    ...
                                    <div className="space-y-4">
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-gray-400 mt-0.5">Nhận cập nhật về các đơn
                                                    hàng thiết kế và tin nhắn hệ thống.</p>
                                            </div>
                                            <button
                                                type="button"
                                            ...
                                            >
                                                <span
                                                    className={`absolute top-1 left-1 w-4 h-4 rounded-full bg-white shadow-sm transition-transform duration-250 ${emailNotifications ? "translate-x-5" : "translate-x-0"}`}/>
                                            </button>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-gray-400 mt-0.5">Nhận các thông tin sự kiện
                                                    độc quyền và voucher giảm giá.</p>
                                            </div>
                                            <button
                                                type="button"
                                            ...
                                            >
                                                <span
                                                    className={`absolute top-1 left-1 w-4 h-4 rounded-full bg-white shadow-sm transition-transform duration-250 ${promotionalOffers ? "translate-x-5" : "translate-x-0"}`}/>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        {activeTab === "purchase_history" && (
                            <div className="space-y-6">
                                ...
                                {loadingTasks ? (
                                    ...
                                    <div
                                        className="text-center py-12 bg-[#f8fafc] rounded-2xl border border-dashed border-gray-200">
                                        <ShoppingBag className="w-10 h-10 text-gray-300 mx-auto mb-3"/>
                                        <p className="text-sm font-semibold text-gray-500">Bạn chưa mua gói dịch vụ
                                            nào</p>
                                        <p className="text-xs text-gray-400 mt-1">Khám phá các dịch vụ thiết kế của
                                            chúng tôi để bắt đầu.</p>
                                    </div>
                                ) : (
                                    <div
                                        ...
                                        <div className="overflow-x-auto">
                                            <table className="w-full text-left border-collapse">
                                                ...
                                                <tr className="bg-slate-50 border-b border-gray-100">
                                                    <th className="px-6 py-4 text-[11px] font-bold text-gray-400 uppercase tracking-wider">Tên
                                                        dịch vụ
                                                    </th>
                                                    <th className="px-6 py-4 text-[11px] font-bold text-gray-400 uppercase tracking-wider">Designer</th>
                                                    <th className="px-6 py-4 text-[11px] font-bold text-gray-400 uppercase tracking-wider">Chi
                                                        phí
                                                    </th>
                                                    <th className="px-6 py-4 text-[11px] font-bold text-gray-400 uppercase tracking-wider">Trạng
                                                        thái
                                                    </th>
                                                    <th className="px-6 py-4 text-[11px] font-bold text-gray-400 uppercase tracking-wider">Ngày
                                                        mua
                                                    </th>
                                                </tr>
                                                </thead>
                                ...
                                {/* Thêm phần Lịch sử mua sản phẩm bên dưới bảng Dịch vụ */}
                                {/* Phần Lịch sử mua sản phẩm */}
                                <div className="mt-12">
                                    <div className="mb-4">
                                        <h3 className="text-base font-bold text-gray-800 border-l-[3px] border-[#6b5b95] pl-3">
                                            Sản phẩm đã mua
                                        </h3>
                                        <p className="text-xs text-gray-400 ml-4 mt-1">
                                            Các tài nguyên, thiết kế bạn đã sở hữu.
                                        </p>
                                    </div>
                        ...
                        {activeTab === "change_password" && user.provider === "LOCAL" && (
                            <form onSubmit={handleChangePassword} className="space-y-6">
                                ...
                                {pwdSuccessMsg && (
                                    <div
                                        className="p-4 bg-emerald-50 border border-emerald-100 text-emerald-600 rounded-2xl text-sm font-medium flex items-center gap-2 animate-in fade-in">
                                        <Check className="w-5 h-5"/>
                                        {pwdSuccessMsg}
                                    </div>
                                )}
                                ...
                                {pwdErrorMsg && (
                                    <div
                                        className="p-4 bg-red-50 border border-red-100 text-red-500 rounded-2xl text-sm font-medium animate-in fade-in">
                                        {pwdErrorMsg}
                                    </div>
                                )}
                        ...
                        {activeTab === "upgrade_designer" && (user.role === "CUSTOMER" || user.role === "ROLE_CUSTOMER") && (
                            <form onSubmit={handleUpgradeToDesigner} className="space-y-8 animate-in fade-in">
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400 ml-4">
                                        Vui lòng điền thông tin chuyên môn bên dưới để kích hoạt tài khoản Designer của
                                        bạn.
                                    </p>
                                </div>
                                ...
                                {designerSuccessMsg && (
                                    <div
                                        className="p-4 bg-emerald-50 border border-emerald-100 text-emerald-600 rounded-2xl text-sm font-medium flex items-center gap-2">
                                        <Check className="w-5 h-5"/>
                                        {designerSuccessMsg}
                                    </div>
                                )}
                                ...
                                {designerErrorMsg && (
                                    <div
                                        className="p-4 bg-red-50 border border-red-100 text-red-500 rounded-2xl text-sm font-medium">
                                        {designerErrorMsg}
                                    </div>
                                )}
                                ...
                                <div
                                    className="p-6 bg-purple-50/30 rounded-2xl border border-purple-100 flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        <Award className="w-10 h-10 text-[#6b5b95]"/>
                                        <div>
                                            <p className="text-sm font-bold text-gray-800">Quyền lợi Designer cao
                                                cấp</p>
                                            <p className="text-xs text-gray-400">Bạn sẽ có Portfolio riêng và bắt đầu
                                                kiếm tiền ngay lập tức.</p>
                                        </div>
                                    </div>
                                    <button
                                        type="submit"
